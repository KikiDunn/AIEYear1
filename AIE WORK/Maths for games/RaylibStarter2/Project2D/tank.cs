...
namespace Project2D
{
	class Tank : GameObject
	{
		...
		public Tank(string image) : base(image)
		{
			...
			//creates a node gameobject that is a child of the tank that the 
			//turret sprite is a child of and can rotate around
		...
		public override void Update(float fDeltaTime)
		{
			...
			//calculates velocity and acceleration from key presses
		...
		{
			//bounces when a collision happens
